"""
Add KazAnova magic and geo clusters
"""
import argparse
import logging
import time
...
numeric_features = ["bathrooms", "bedrooms", "latitude", "longitude", "price", "price_mod_100", "image_timestamp",
                    "has_dupe_photo"]
...
def run(train_file, test_file, train_feature_file, test_feature_file, feature_map_file,
    ...
    count_feature_names = add_small_count_features(train_df, test_df, categorical_features + added_geo_feats)
    ...
    features_to_use = numeric_features + added_geo_feats + added_nth_feats + added_manager_cv_feats + \
                      added_building_cv_feats + added_manager_nth_cv_feats + added_features + \
                      categorical_features + count_feature_names
